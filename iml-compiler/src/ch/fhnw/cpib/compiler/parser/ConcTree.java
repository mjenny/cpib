...
public interface ConcTree {
	...
	public class Parameter {
		...
		public Parameter(OptionalFlowMode optionalFlowMode, OptionalMechMode optionalMechMode, StorageDeclaration storageDeclaration) {
			this.optionalFlowMode = optionalFlowMode;
		...
		public AbsTree.Parameter toAbstract(RepeatingOptionalParameters repeatingOptionalParameters) {
			return new AbsTree.Parameter(optionalFlowMode.toAbstract(), optionalMechMode.toAbstract(), storageDeclaration.toAbstract(null), repeatingOptionalParameters.toAbstract());
		}
	}
	//18.12.
